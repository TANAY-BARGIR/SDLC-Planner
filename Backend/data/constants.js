...
const COCOMO_MODES = {
  ORGANIC: {
    ...
    c: 2.5,
    d: 0.38,
    desc: "Small, simple projects with experienced teams.",
  },
  SEMI_DETACHED: {
    a: 3.0,
    b: 1.12,
    c: 2.5,
    d: 0.35,
    desc: "Intermediate size and complexity.",
  },
  EMBEDDED: {
    a: 3.6,
    b: 1.2,
    c: 2.5,
    d: 0.32,
    desc: "Tight constraints, complex hardware/software interactions.",
  },
};
...
module.exports = { COCOMO_MODES, SDLC_TYPES, RISK_LEVELS, ARCH_TYPES };
